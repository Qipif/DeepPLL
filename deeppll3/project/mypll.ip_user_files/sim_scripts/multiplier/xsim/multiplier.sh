...
#
# Script generated by Vivado on Sun May 17 15:32:00 +0800 2026
...
# script info
echo -e "multiplier.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xbip_utils_v3_0_15 -L mult_gen_v12_0_24 -L secureip -L xpm --snapshot multiplier xil_defaultlib.multiplier -log elaborate.log
}
...
Usage: multiplier.sh [-rerun]\n\
Usage: multiplier.sh [-reset_run]\n\
Usage: multiplier.sh [-clean]\n\
