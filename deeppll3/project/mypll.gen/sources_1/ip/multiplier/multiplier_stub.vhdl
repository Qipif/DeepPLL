...
--               c:/Users/qipif/Desktop/FPGAProject/01_Preference/08_mypll/project/mypll.gen/sources_1/ip/multiplier/multiplier_stub.vhdl
-- Design      : multiplier
...
entity multiplier is
  ...
  attribute core_generation_info of multiplier : entity is "multiplier,mult_gen_v12_0_24,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=mult_gen,x_ipVersion=12.0,x_ipCoreRevision=24,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_VERBOSITY=0,C_MODEL_TYPE=0,C_OPTIMIZE_GOAL=1,C_XDEVICEFAMILY=artix7,C_HAS_CE=0,C_HAS_SCLR=0,C_LATENCY=1,C_A_WIDTH=12,C_A_TYPE=0,C_B_WIDTH=12,C_B_TYPE=0,C_OUT_HIGH=23,C_OUT_LOW=0,C_MULT_TYPE=1,C_CE_OVERRIDES_SCLR=0,C_CCM_IMP=0,C_B_VALUE=10000001,C_HAS_ZERO_DETECT=0,C_ROUND_OUTPUT=0,C_ROUND_PT=0}";
